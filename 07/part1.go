...
func is_operation_valid(result int, operands []int, operand_idx int, carry int, operator rune) bool {
	var plus_is_valid, times_is_valid bool
	var next_carry int
	...
	return plus_is_valid || times_is_valid
}
